...
public class AllFavouritesViewHolder extends RecyclerView.ViewHolder {
    public ImageView image;
    public TextView brand, price;

    public AllFavouritesViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void showData(AllFavouritesItem data, Activity activity) {
